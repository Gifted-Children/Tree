...
bg = pygame.image.load("./background.png") #배경 불러오기

char = pygame.image.load("./char.png")#캐릭터 불러오기
...
char_ground = char_y_pos = sc_h - char_height   #캐릭터 위치 Y축으로는 맨 아래
...
while run:
    if(isJump):
        ...
        if(char_y_pos > char_ground):
            char_y_pos = char_ground
            isJump = False
